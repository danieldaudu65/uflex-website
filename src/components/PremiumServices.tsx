...
const PremiumServices: React.FC = () => {
  ...
  const handleBookNow = (service: any) => {
    ...
    navigate(`/booking/book`, { state: { service } });
  };
    ...
    <div className="px-4 md:px-12 lg:px-24 py-12 bg-white">
      ...
      <div className="text-center max-w-3xl mx-auto mb-12">
        <h3 className="text-2xl text-green-main md:text-4xl font-extrabold mb-4 text-gray-900 leading-tight">
          Our Car Renting Services <br className="hidden md:block" />
          <span className="">for Travelers</span>
        </h3>
        ...
        {premiumServiceDetiail.map((prem, idx) => (
          ...
          >
            ...
            <div className="p-3">
              ...
              <button
                className="lg:w-1/2 cursor-pointer py-2 rounded-lg mb-6 w-full mt-3 bg-green-main text-white font-semibold"
                onClick={() => handleBookNow(prem)}
              >
                Book Now
              </button>
            </div>
